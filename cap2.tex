...
\begin{itemize}
  ...
  \item Apache HTTPD para proveer el servicio de \textsc{HTTPS}
...
La siguiente figura muestra el diagrama de la interfaz de administraci\'{o}n \textsc{SSH} y la interfaz de acceso a los archivos \textsc{WebDAV} sobre \textsc{HTTPS}, ambas utilizan el directorio \textsc{OpenLDAP} para autenticar a los usuarios de manera centralizada.
...
Para el caso del acceso v\'{i}a \textsc{WebDAV} es necesario un cliente, los sistemas operativos de escritorio como \textsc{GNU/Linux}, \textsc{Solaris}, \textsc{*BSD\footnote{Cualquier versi\'{o}n de BSD como \textsc{OpenBSD, FreeBSD y NetBSD}}}, \textsc{Mac OS X} y Windows tienen un cliente nativo en sus interfaces gr\'{a}ficas del navegador de archivos.
...
En los sistemas operativos m\'{o}viles como \textsc{Android} y Apple \textsc{iOS} es posible instalar clientes para acceder a los archivos v\'{i}a \textsc{WebDAV}, si no se desea acceder por este medio se puede utilizar la interfaz web est\'{a}ndar.
