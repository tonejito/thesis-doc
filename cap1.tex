...
\begin{itemize}
  ...
  \item Sistemas embebidos de control y RTOS \footnote{\textit{Real Time Operating System} por sus siglas en ingl\'{e}s.} \cite{_uclinux_????}\cite{_rtos_????}.
  ...
  \item HTPC (Dispositivos de entretenimiento casero) \cite{_openelec_????}
