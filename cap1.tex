...
\cline{1-5}
NVRAM & MB & \yesmark & \yesmark & \yesmark &  \\
\cline{1-5}
ROM & MB & \yesmark & \yesmark & \nomark &  \\
\cline{1-5}
EEPROM & MB & \yesmark & \yesmark & \nomark &  \\
\cline{1-5}
FLASH / SSD & GB & \yesmark & \yesmark & \yesmark &  \\
\hline
...
El protocolo SSH \footnote{Secure Shell por sus siglas en ingl\'{e}s.} sirve para establecer sesiones remotas cifradas entre dos equipos \cite{gwolf}. Utiliza cifrado asim\'{e}trico para proteger la conexi\'{o}n y soporta m\'{u}ltiples m\'{e}todos de autenticaci\'{o}n lo que permite que sea flexible y f\'{a}cil de incluir en varios sistemas operativos.
...
Com\'{u}nmente se utiliza para conectarse a un servidor y utilizar la interfaz de l\'{i}nea de comandos, aunque el protocolo es muy flexible y se puede utilizar para cumplir las funciones que se listan a continuaci\'{o}n:
  ...
  \begin{itemize}
    ...
    \item{Generar un proxy SOCKS para enviar el tr\'{a}fico local al equipo remoto \textit{DynamicForward}.}
  \end{itemize}
