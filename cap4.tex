...
\end{itemize}
  ...
  \picturebox{figures/SSL-Labs_Test-Default}{772}{476}{0.8}{Prueba de par\'{a}metros de cifrado \textsc{HTTPS} est\'{a}ndar}{ssl-test-default}
...
% https://www.ssllabs.com/ssltest/analyze.html?d=xnas.tonejito.org&hideResults=on&clearCache=on
  ...
  \picturebox{figures/SSL-Labs_Test-Enhanced}{772}{346}{0.8}{Prueba de par\'{a}metros de cifrado \textsc{HTTPS} reforzados}{ssl-test-enhanced}
