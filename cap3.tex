...
\end{verbatim}
          ...
          \subsubsection {Configuraci\'{o}n de \textup{OpenLDAP}}
...
\begin{itemize}
  ...
  \item Deshabilita expl\'{i}citamente el uso de \textsc{SSLv2}, \textsc{SSLv3} y \textsc{TLSv1}, para evitar las vulnerabilidades \textsc{POODLE}\cite{_poodle_????} y \textsc{DROWN}\cite{_drown_????}
