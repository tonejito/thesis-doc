...
%
% A pesar de que se realiz\'{o} el an\'{a}lisis y comparativa de los tipos de arreglo \textsc{RAID}, en el prototipo final no se implement\'{o} esta funcionalidad debido a que el equipo proporcionado solo contaba con un disco duro y tampoco fue posible obtener una tarjeta controladora.
