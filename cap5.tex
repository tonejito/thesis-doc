...
Utilizar directivas din\'{a}micas de control de acceso puede smplificar las directivas de control de acceso utilizadas en el sistema. Esta caracter\'{i}stica esta disponible en Apache \textsc{HTTPD} 2.4. \cite{_mod_authz_core_????} \cite{_mod_authnz_ldap_????}
