{
  ...
  \label{apdx:a}
    ...
    \label{sec:man-cert}
      ...
      \subsection {Navegador web Mozilla Firefox}
...
\begin{enumerate}
  ...
  \item Abrir el sitio en el navegador web \textsl{Firefox}. Aparecer\'{a} una ventana donde se pregunta la funci\'{o}n del certificado ra\'{i}z, seleccionar la primer opci\'{o}n y dar clic en el bot\'{o}n \textbf{OK}.
...
%  \item Esperar a que termine de ejecutar el \textit{script} y dar clic en el bot\'{o}n \textbf{cerrar}.
%
...

{
 ...
 {%
  \begin{tabular}[c]{c|l}
  \textbf{Elemento}                             & \multicolumn{1}{c}{\textbf{Componente de \textsc{URL}}} \\
  \hline \hline
  ...
  \textit{ID de materia}                     & \hspace{3mm}$\hookrightarrow$ \texttt{1024} \\
  \textit{ID de grupo}                         & \hspace{6mm}$\hookrightarrow$ \texttt{8} \\
  %\hline
