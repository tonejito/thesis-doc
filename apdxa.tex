...
\begin{itemize}
  ...
  \picturebox{figures/Windows-001}{359}{39}{0.75}

  \item Escribir el n\'{u}mero de cuenta y la contrase\~{n}a en el cuadro de di\'{a}logo:

  \picturebox{figures/Windows-Alumno-Firefox}{610}{282}{0.75}
  \picturebox{figures/Windows-Alumno-Chrome}{452}{323}{0.75}
  \picturebox{figures/Windows-Alumno-Opera}{426}{335}{0.75}
  \picturebox{figures/Windows-Alumno-InternetExplorer}{481}{314}{0.75}
\end{itemize}
}
...
\begin{enumerate}
  ...
  \picturebox{figures/Linux-002}{449}{379}{0.75}
