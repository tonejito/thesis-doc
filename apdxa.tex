...
%  \picturebox{figures/Windows-Alumno-InternetExplorer}{481}{314}{0.7}
  ...
  \item Abrir la carpeta que corresponde al nombre del profesor, materia y grupo. Ver secci\'{o}n \ref{sec:man-ro} en la p\'{a}gina \pageref{sec:man-ro} para conocer la nomenclatua de las carpetas.
...
\newpage
  ...
  \item Abrir la carpeta que corresponde al nombre del profesor. Ver secci\'{o}n \ref{sec:man-rw} en la p\'{a}gina \pageref{sec:man-rw} para conocer la nomenclatua de las carpetas.
